package com.isme.nunu.config;

import com.isme.nunu.security.AuthoritiesConstants;
import com.isme.nunu.security.jwt.JWTFilter;
import com.isme.nunu.security.jwt.TokenProvider;
import com.isme.nunu.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/services/**", "/swagger-resources/**", "/v2/api-docs", "/v3/api-docs").authenticated()
